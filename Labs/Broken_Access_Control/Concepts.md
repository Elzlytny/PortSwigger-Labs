...
لكن حتى لو الرابط كان **Unpredictable**، فمجرد معرفة الرابط لا يعني إن المستخدم المفروض يقدر يستخدمه. التطبيق لازم يطبق **Server-side Authorization** على كل Request، بغض النظر عن مدى صعوبة تخمين الـ URL.
...
> لا تعتمد أبدًا على أي بيانات قادمة من الـ **Client** لاتخاذ قرارات الـ **Authorization**. يجب تحديد صلاحيات المستخدم والتحقق منها دائمًا على الـ **Server**.
